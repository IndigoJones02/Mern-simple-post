...
const dbUrl = `mongodb+srv://indigojones:create45@cluster0.dsss5r0.mongodb.net/?retryWrites=true&w=majority`;
...
let PostModel = mongoose.model("book", postSchema);
...
/** POST API: Gets a new post info from React and adds it to DB */
